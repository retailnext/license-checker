    ...
    if (licenseData) {
        ...
        files.forEach(function(filename) {
            ...
            if (fs.lstatSync(licenseFile).isFile()) {
                var l = license(fs.readFileSync(licenseFile, {encoding: 'utf8'}));
                if (moduleInfo.licenses == UNKNOWN && (l != null && l != 'Undefined')) {
                    moduleInfo.licenses = l;
                }
            }
        });
    }
